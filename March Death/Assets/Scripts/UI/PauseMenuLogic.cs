...
public class PauseMenuLogic : MonoBehaviour {
	...
	void Start () {
		GameObject.Find("Button").GetComponent<Button>().onClick.AddListener( () => { QuitPauseMenu (); } );
		GameObject.Find("exit button").GetComponent<Button>().onClick.AddListener( () => { QuitToMainMenu (); } );
	}

...
namespace Storage
{
    ...
    sealed class Info : Singleton<Info>
    {
        ...
        private Info()
        {
			...
			parseJSONFiles<ArcheryInfo, BuildingTypes>("Data/Buildings/Archery", buildingStore, EntityType.BUILDING);
            parseJSONFiles<StableInfo, BuildingTypes>("Data/Buildings/Stable", buildingStore, EntityType.BUILDING);
			...
			parsePrefabs<Archery, BuildingTypes>("Prefabs/Buildings/Archery", buildingPrefabs);
            parsePrefabs<Stable, BuildingTypes>("Prefabs/Buildings/Stable", buildingPrefabs);
        }
